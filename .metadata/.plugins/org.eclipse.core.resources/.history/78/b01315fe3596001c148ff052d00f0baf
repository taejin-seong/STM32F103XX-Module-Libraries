...
/**
 * @brief   3000개 트랙 지원하는 폴더에서  선택하여 재생
 * @note    01~15 폴더명 한에서 각 폴더에 최대 3000개 트랙을 지원함.
 * @param  	folder  		1~ 15
 * @param  	track  			1 ~ 30000 (or 0 ~ 2999) 파일명 넘버링에 따라 둘 중 하나의 범위를 가짐
 */
 ...
 * @warning 폴더 이름은 01~99까지만 가능, 각 폴더 내에는 255개 mp3/wmv 파일만 가능
 */
 ...
 *
 */
void dfplayer_RandomTrack(void) //TODO ongoing - 1
{
